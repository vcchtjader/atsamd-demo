...
use atsamd_hal::{
    clock::v2::{gclk, xosc::*, DpllConfig, GclkConfig, GclkOut, Pclk, Tokens},
    gpio::v2::Pins,
    time::U32Ext,
};
...
mod app {
    ...
    fn init(cx: init::Context) -> (init::LateResources, init::Monotonics()) {
        ...
        //.set_div(CFDPRESC_A::div1).enable();
        let xosc0 = xosc_config0.enable();
        ...
        //.enable();
        //
        let dpll0 = dpll0.enable();
        //let (gckl1, _xosc0) = GclkConfig::new(tokens.gclks.gclk1, xosc0);
